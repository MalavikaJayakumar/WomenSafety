...
if (mysqli_num_rows($result) > 0) {
    ...
    $row = mysqli_fetch_assoc($result);
        ...
        echo "<br>" . $row["id"] ;
        echo "<br>". $row["spot_name"];
        echo "<br>" . $row["ammenity"];
        echo "<br>" . $row["contact"];
        echo "<br>" . $row["web"];
        echo "<br>" . $row["email"];
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="types">
                        ...
                        <option value="Hotel">Processing</option>
                        <option value="Hostel">Accepted</option>
                        <option value="Comfort Station">Rejected</option>
                      </select>
                    </div>
                  </div>                  
